...
print([randint(-100, 100) for i in range(n_size)])
print('*' * 70)
...
print('С сохранением изначального порядка следования уникальных элементов')
print([input_list[i] for i in range(len(input_list)) if not input_list[i] in input_list[:i]])
print('С неизвестными возможными перестановками элементов')
